...
import com.ilonw.server.repository.shop.OmsCartItemMapper;
...
public class OmsCartItemServiceImpl implements OmsCartItemService {
    ...
    public int add(OmsCartItem cartItem) {
        int count;
        // todo 带实现
        IlonwUserBO ilonwUserBO = null;
        cartItem.setMemberId(ilonwUserBO.getIlonwUserId());
        cartItem.setMemberNickname(ilonwUserBO.getIlonwUserNikename());
