...
public class ProductServiceImpl implements ProductService {
    ...
    public int create(ProductParam productParam) {
        ...
        //关联专题
        relateAndInsertList(cmsSubjectProductRelationDao, productParam.getSubjectProductRelationList(), productId);
        //关联优选
        relateAndInsertList(cmsPrefrenceAreaProductRelationDao, productParam.getPrefrenceAreaProductRelationList(), productId);
        count = 1;
        return count;
    }
    ...
    public int update(Long id, ProductParam productParam) {
        ...
        relateAndInsertList(cmsPrefrenceAreaProductRelationDao, productParam.getPrefrenceAreaProductRelationList(), id);
        count = 1;
        return count;
    }
